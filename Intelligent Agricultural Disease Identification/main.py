...
class Window(QWidget):
    def __init__(self):
        ...
        self.label_result = None  # 实时结果显示标签
        self.timer = None
        self.im1 = cv2.imread('ui_img/plant.jpg', cv2.IMREAD_COLOR)
        self.V = True
        self.n = 0
        self.p = None
        self.cap = cv2.VideoCapture()
        self.result = cv2.imread('plants_img/shibie.png', cv2.IMREAD_COLOR)
        # 设置全屏显示
        # self.showFullScreen()
        # 设置窗口标题
        self.setWindowTitle("智慧农业病害识别系统")
        # 隐藏窗口标题栏
        ...
        # 设置窗口大小
        self.width = pixmap.width()  # 获取背景图的宽度1280
        self.height = pixmap.height()  # 获取背景图的高度720
    ...
    def setup_ui(self):
        ...
        self.btn_close.setStyleSheet("""
                    QPushButton{
                        border-image: url(./ui_img/return.jpg);  /* 按钮背景图片 */
                    }
                """)
        self.btn_close.resize(48, 48)
        self.btn_close.move(1160, 56)
        ...
        self.label_video.setStyleSheet("""
                        ...
                        """)
        self.label_video.resize(632, 472)
        self.label_video.move(81, 152)
        ...
        self.label_result.setStyleSheet("""
                        ...
                        """)
        self.label_result.resize(462, 472)
        self.label_result.move(729, 152)
    ...
    def detect(self,
               weights=ROOT / 'weights/plant-zh.pt',  # model path or triton URL
        ...
        result_img = ['shibie.png', 'ebym.png', 'ngbfb.png', 'mlc.png', 'zljm.png', 'yfs.png', 'ymyye.png',
                      'ymncwhz.png', 'fqybb.png', 'fqwyb.png', 'fqhhqyb.png', 'djyc.png', 'dzjym.png', 'dh.png',
                      'hyde.png', 'pgxb.png', 'pghxb.png', 'pghfb.png', 'cmhbb.png', 'pthsmz.png', 'ljjbb.png']
    ...
    def update_gui(self):
        while True:
            show_image_on_label(self.im1, self.label_video, 632, 472)
            show_image_on_label(self.result, self.label_result, 462, 472)
            # 增加延时，降低卡顿。
            time.sleep(0.2)
